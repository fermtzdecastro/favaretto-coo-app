...
interface IngresosDelMesProps {
  breakdown: IngresosBreakdown;
}

const rows: { key: keyof Omit<IngresosBreakdown, "total">; label: string }[] = [
...
export function IngresosDelMes({ breakdown }: IngresosDelMesProps) {
  return (
    <Card>
      <h2 className="mb-4 font-heading text-lg font-semibold">Ingresos del mes</h2>
